...
class App extends MY_Controller {
	...
	public function allofflineorder(){
...

            {
				...
				$offlineo="order_status=1 AND order_date='".$crdate."'";

				$orderinfo=$this->db->select("*")->from('customer_order')->where($offlineo)->get()->result();
	...
	public function order_status(){
...

            {
				...
				$all="order_date='".$crdate."'";

				// $orderinfo=$this->db->select("*")->from('customer_order')->get()->result();
				$orderinfo=$this->db->select("*")->from('customer_order')->where($all)->get()->result();
