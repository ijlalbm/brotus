  ...
  function payupfront() {
      ...
      if (errormessage == '') {
          ...
          $.ajax({
              ...
              url: basicinfo.baseurl + "ordermanage/order/pos_order_payup",
                      ...
                      swal({
                          ...
                          function(isConfirm) {
                              ...
                              if (isConfirm) {
                                  var orderId = '00' + data;
                                  console.log(orderId);
                                  createMargeorderPayUp(orderId, 1);
  ...
  function createMargeorderPayUp(orderid, value = null) {

      var csrf = $('#csrfhashresarvation').val();

      var url = 'showpaymentmodalPayUp/' + orderid;
  ...
  function completePayUp(orderid, value = null) {

      var csrf = $('#csrfhashresarvation').val();

      var url = 'complete_payupfront/' + orderid;
  ...
  function submitmultiplepayPayup() {
      ...
      $.ajax({
          ...
          url: basicinfo.baseurl + "ordermanage/order/paymultiple_payupfront",
