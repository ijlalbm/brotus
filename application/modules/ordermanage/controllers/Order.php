...
class Order extends MX_Controller {
	...
	public function pos_order_payup($value=null){
	...
	public function showpaymentmodalPayup($id,$type=null){
		...
		$this->load->view('ordermanage/paymodalPayUp',$data); 

		}

		else{

			$this->load->view('ordermanage/newpaymentveiwPayUp',$data); 
	...
	public function paymultiple_payupfront(){
	...
	public function complete_payupfront($id){
