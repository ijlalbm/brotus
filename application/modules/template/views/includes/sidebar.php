<div class="sidebar">
    ...
    <div class="user-panel text-center">
        ...
        <div class="info">
            ...
            <a href="#" class="admin"><i class="fa fa-circle text-success admin"></i> <?php echo $this->session->userdata('user_level') ?></a>
    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview <?php echo (($this->uri->segment(2)=="home" || $this->uri->segment(2)=="")?"active":null) ?>">
            ...
            <a href="<?php echo base_url('dashboard/home') ?>"><i class="ri-home-3-line"></i> <span><?php echo display('dashboard')?></span> 
        ...
        ************************************* -->
		...
		$HmvcMenu2["ordermanage"] = array(
    		...
    		"icon" => "<i class='ri-contacts-book-2-line' aria-hidden='true'></i>", 
		...
		$HmvcMenu2["reservation"] = array(
    		...
    		"icon" => "<i class='ri-function-line' aria-hidden='true'></i>", 
		...
		$HmvcMenu2["purchase"] = array(
    		...
    		"icon"=> "<i class='ri-shopping-cart-2-line' aria-hidden='true'></i>", 
			...
			"adjusment_stock" => array("controller" => "purchase","method"     => "adjusment_stock","permission" => "create"),

		); 

		$HmvcMenu2["report"] = array(

    		"icon" => "<i class='ri-file-list-3-line' aria-hidden='true'></i>", 
		...
		$HmvcMenu2["itemmanage"] = array(
    		...
    		"icon"           => "<i class='ri-archive-line' aria-hidden='true'></i>", 
		...
		$HmvcMenu2["production"] = array( 
    		...
    		"icon"           => "<i class='ri-funds-box-line' aria-hidden='true'></i>", 
		...
		$HmvcMenu2["setting"] = array(
    		...
    		"icon"           => "<i class='ri-settings-4-line' aria-hidden='true'></i>", 
